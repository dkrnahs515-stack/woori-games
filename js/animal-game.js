...
function checkAnswer(selectedAnimal) {
    ...
    if (selectedAnimal.name === currentAnimal.name) {
        ...
        feedbackDiv.innerHTML = `🎉 우리야 정답! ${currentAnimal.emoji} ${currentAnimal.name}의 소리예요! 🎉`;
        ...
        // 오답
        feedbackDiv.innerHTML = `😊 ${selectedAnimal.emoji}${selectedAnimal.name}는 ${selectedAnimal.sound} 하고 울어요. 우리야 다시 해봐!`;
